...
export default function ViewSelectVacante({ open, handleClose, vacantData, charges, areas, setReload, reload }: IModalProps) {
  ...
  const handleDeleteVacante = async () => {
    try {
      ...
      setAlertMessage("Vacante eliminada exitosamente");
      setOpenAlert(true);
