...
const MultipleSelectString: React.FC<SelectMultipleInputProps> = ({
  label,
  name,
  options,
  value,
  ...
  const handleChange = (event: any) => {
   ...
   const selectIds = Array.isArray(selectedValues) ? selectedValues : [];
...
export default MultipleSelectString;